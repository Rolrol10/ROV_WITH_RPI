# modules/controllers/wheel.py

import pygame
import asyncio
import websockets
import json
from modules.controllers.mappings.wheel_mapping import *
...
STREAM_TYPE = "stream"
BUTTON_MAP = {
    "start_stream": BTN_START,
    "stop_stream": BTN_SELECT,
    "restart_stream": BTN_A,
}
    ...
    try:
        async with websockets.connect(ws_url, ping_interval=30, ping_timeout=20) as ws:
            ...
            while True:
                ...
                if joystick_count == 0:
                    if was_connected:
                        print("⚠️ Wheel disconnected! Sending failsafe.")
                ...
                steer = apply_deadzone(joystick.get_axis(AXIS_STEER))
                tilt = apply_deadzone(-joystick.get_axis(AXIS_ACCEL))
                ...
                try:
                    ...
                    print("🔌 Wheel WebSocket disconnected.")
                    return
